...
<div class="container">
	<div class="header">
		...
		<ul class="menu list-unstyled">
			<li class="activate"><a href="index.jsp">切换登陆</a></li>
			...
			<ul class="sub-menu list-unstyled">
				...
				<li><a href="lookbytitle.jsp">名称查询</a></li>
    ...
    <div id="fwslider"><!-- start slider -->
        <div class="slider_container">
            <div class="slide"> 
                ...
                <div class="slide_content">
                    <div class="slide_content_wrap">
                        <!-- Text title -->
                        <h4 class="title">欢迎使用科研成果管理系统</h4>
                        <!-- /Text title -->
                        <!-- Text description -->
                        <p class="description">Welcome to the management system of research achievements</p>
                        <!-- /Text description -->
                    </div>
                </div>
                 <!-- /Texts container -->
            ...
            <div class="slide">
                ...
                <div class="slide_content">
                    <div class="slide_content_wrap">
                        <h4 class="title">规格严格    功夫到家</h4>
                        <p class="description">Strict criterions Solid Skills</p>
                    </div>
                </div>
            </div>
            <!--/slide -->
