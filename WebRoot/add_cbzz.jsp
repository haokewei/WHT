...
<div class="container">
	...
	<hr  width="100%" size="10" >
		...
		<table border="2" cellsapcing="0" cellpadding ="0" bgcolor="cccaaa" width="55%" align="center">
		<tr>
		<td height="30">专著名称:</td>
		<td><input name="Zzmc" type="text" size ="60"></td>
		</tr>
		<tr>
		<td height ="30">出版社名称:</td>
		<td>
		<input name="Cbsmc" type="text" size ="60">
		</td>
		</tr>
		<tr>
		<td height ="30">出版时间:</td>
		<td>
		<input name="Cbsj" type="text" size ="60">
		</td>
		</tr>
		<tr>
		<td height ="30">著者名单:</td>
		<td>
		<input name="Zzmd" type="text" size ="60">
		</td>
		</tr>
		<tr>
		<td height ="30">工作量分值:</td>
		<td>
		<input name="Gzlfz" type="text" size ="60">
		</td>
		</tr>
		<tr>
