...
<div class="container">
	<div class="header">
		...
		<hr  width="100%" size="10" >
            ...
            <br>  </br>  
		<div align="center">
		<form action="update_jxxx" method= "post">
		<table border="2" cellsapcing="0" cellpadding ="0" bgcolor="cccaaa" width="50%" align="center">
		<tr>
		<td height="30">进修学习单位:</td>
		<td><input type="hidden" name="Jxxxdw" value="<s:property value="Jxxxdw"/>"><s:property value="Jxxxdw"/></td>
		</tr>
		<tr>
		<td height ="30">进修学习内容:</td>
		<td><input type="text" name="Jxxxnr" value="<s:property value="Jxxxnr"/>"></td>
		</tr>
		<tr>
		...
		<tr>
		<td height ="30">人员姓名:</td>
		<td><input type="text" name="Ryxm" value="<s:property value="Ryxm"/>"></td>
		</tr>
		<tr>
