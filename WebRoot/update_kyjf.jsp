...
<div class="container">
	<div class="header">
		...
		<hr  width="100%" size="10" >
            ...
            <br>  </br>  
		<div align="center">
		<form action="update_kyjf" method= "post">
		...
		<tr>
		<td height ="30">年份:</td>
		<td><input type="text" name="Nf" value="<s:property value="Nf"/>"></td>
		</tr>
		<tr>
		<td height="30">到款:</td>
		<td><input type="text" name="Dk" value="<s:property value="Dk"/>"></td>
		</tr>
		<tr>
		<td height="30">未到款:</td>
		<td><input type="text" name="Wdk" value="<s:property value="Wdk"/>"></td>
		</tr>
		<tr>
