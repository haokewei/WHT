...
<div class="container">
	<div class="header">
		...
		<hr  width="100%" size="10" >
            ...
            <br>  </br>  
		<div align="center">
		<form action="update_rjzzq" method= "post">
		<table border="2" cellsapcing="0" cellpadding ="0" bgcolor="cccaaa" width="50%" align="center">
		<tr>
		<td height="30">软件著作权名称:</td>
		<td><input type="hidden" name="Rjzzqmc" value="<s:property value="Rjzzqmc"/>"><s:property value="Rjzzqmc"/></td>
		</tr>
		<tr>
		<td height="30">软件著作权登记号:</td>
		<td><input type="hidden" name="Rjzzqdjh" value="<s:property value="Rjzzqdjh"/>"><s:property value="Rjzzqdjh"/></td>
		</tr>
		<tr>
		<td height ="30">著作权人:</td>
		<td><input type="text" name="Zzqr" value="<s:property value="Zzqr"/>"></td>
		</tr>
		<tr>
		...
		<tr>
		<td height ="30">授予时间:</td>
		<td><input type="text" name="Sysj" value="<s:property value="Sysj"/>"></td>
		</tr>
		<tr>
