	...
	<div class="header">
		...
		<ul class="menu list-unstyled">
			...
			<ul class="sub-menu list-unstyled">
				<li><a href="add_kyjfdk.jsp">科研经费到款申报</a></li>
				<li><a href="add_kyxm.jsp">科研项目申报</a></li>
				<li><a href="add_rjzzq.jsp">软件著作权申报</a></li>
				...
				<li><a href="add_jxxx.jsp">国内外进修及学习申报</a></li>
				<li><a href="add_gjhz.jsp">国际合作申报</a></li>
			</ul>
			</li>
		...
		<hr  width="100%" size="10" >
            ...
            <br>  </br>  
		<div align="center">
		<form action="add_kyjf" method= "post">
		...
		<td height ="30">年份:</td>
		<td>
		<input name="Nf" type="text" size ="30">
		</td>
		</tr>
		<tr>
		<td height="30">到款:</td>
		<td><input name="Dk" type="text" size ="30">
		</td>
		</tr>
		<tr>
		<td height="30">未到款:</td>
		<td><input name="Wdk" type="text" size ="30">
		</td>
		</tr>
		<tr>
		<td height="30">课题合同号:</td>
		<td><input name="Kthth" type="text" size ="30">
		</td>
		</tr>
		<tr>
		<td height="30">经费卡号:</td>
		<td><input name="Jfkh" type="text" size ="30">
		</td>
		</tr>
		<tr>
		<td height="30">备注:</td>
		<td><input name="Bz" type="text" size ="30">
		</td>
		</tr>
		<tr>
