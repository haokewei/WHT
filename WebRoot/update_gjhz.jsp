...
<div class="container">
	<div class="header">
		...
		<hr  width="100%" size="10" >
            ...
            <br>  </br>  
		<div align="center">
		<form action="update_gjhz" method= "post">
		<table border="2" cellsapcing="0" cellpadding ="0" bgcolor="cccaaa" width="50%" align="center">
		<tr>
		<td height="30">类别:</td>
		<td><input type="text" name="Lb" value="<s:property value="Lb"/>"></td>
		</tr>
		<tr>
		<td height ="30">出访/来访人员名单:</td>
		<td><input type="text" name="Rymd" value="<s:property value="Rymd"/>"></td>
		</tr>
		<tr>
		<td height ="30">人数:</td>
		<td><input type="text" name="Rs" value="<s:property value="Rs"/>"></td>
		</tr>
		<tr>
		...
		<tr>
		<td height ="30">出访地/来访地:</td>
		<td><input type="text" name="Dd" value="<s:property value="Dd"/>"></td>
		</tr>
		<tr>
		<td height="30">访问目的:</td>
		<td><input type="text" name="Fwmd" value="<s:property value="Fwmd"/>"></td>
		</tr>
		<tr>
		<td height="30">报告名称:</td>
		<td><input type="text" name="Bgmc" value="<s:property value="Bgmc"/>"></td>
		</tr>
		<tr>
		<td height="30">新闻报道链接:</td>
		<td><input type="text" name="Xwbdlj" value="<s:property value="Xwbdlj"/>"></td>
		</tr>
		<tr>
		<td height="30">新闻报告保存否:</td>
		<td><input type="text" name="Xwbgbcf" value="<s:property value="Xwbgbcf"/>"></td>
		</tr>
		<tr>
		<td height="30">照片保存否:</td>
		<td><input type="text" name="Zpbcf" value="<s:property value="Zpbcf"/>"></td>
		</tr>
		<tr>
