...
<div class="container">
	<div class="header">
		...
		<hr  width="100%" size="10" >
            ...
            <br>  </br>  
		<div align="center">
		<form action="add_rjzzq" method= "post">
		<table border="2" cellsapcing="0" cellpadding ="0" bgcolor="cccaaa" width="50%" align="center">
		<tr>
		<td height="30">软件著作权名称:</td>
		<td><input name="Rjzzqmc" type="text" size ="30"></td>
		</tr>
		<tr>
		<td height="30">软件著作权登记号:</td>
		<td><input name="Rjzzqdjh" type="text" size ="30"></td>
		</tr>
		<tr>
		<td height ="30">著作权人:</td>
		<td>
		<input name="Zzqr" type="text" size ="30">
		</td>
		</tr>
		<tr>
		...
		<td>
		<input name="Sysj" type="text" size ="30">
		</td>
		</tr>
		<tr>
