...
<body>
    <div id="fwslider"><!-- start slider -->
            ...
            <div class="slide"> 
                ...
                <div class="slide_content">
                    <div class="slide_content_wrap">
						...
						<table border="2" cellsapcing="0" cellpadding ="0" bgcolor="cccaaa" width="30%" align="center">
		...
		&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="reset" value="重置" size="12">
		</td>
		</tr>
		</table>
		</form>
		...
		<tr>
		<td height="30">用户名:</td>
		<td><input name="Yhm" type="text" size ="30"></td>
		</tr>
		<tr>
		<td height ="30">密码:</td>
		<td>
		...
		<tr>
		<td colspan="2" align="center">
		<input type="submit" value="注册" size="12">
		&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="reset" value="重置" size="12">
		</td>
		</tr>
