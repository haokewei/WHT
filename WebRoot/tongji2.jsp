...
<td>总分值</td> 
	...
	<td><%out.println(rs.getString("职务职称"));%></td>
	<td><%out.println(rs.getString("岗级"));%></td>
	<td><%out.println(rs.getString("岗位"));%></td>
	<td><%out.println(rs.getString("岗级分值"));%></td>
	<td><%out.println(rs.getString("领导加分"));%></td>
	<td><%out.println(rs.getString("出版专著分值"));%></td>
	<td><%out.println(rs.getString("获奖分值"));%></td>
	<td><%out.println(rs.getString("科研项目分值"));%></td>
	<td><%out.println(rs.getString("学术兼职分值"));%></td>
	<td><%out.println(rs.getString("专利分值"));%></td>
	<td><%out.println(rs.getString("国际合作分值"));%></td>
	<td><%out.println(rs.getString("科研经费分值"));%></td>
	<td><%out.println(rs.getString("软件著作权分值"));%></td>
	<td><%out.println(rs.getString("进修学习分值"));%></td>
	<td><%out.println(rs.getString("总分值"));%></td>
	</tr>
	<%}
	%>	
</table>
...
<center><font size="5">请选择保存路径</font></center>
		<div align="center">
			<form action="dayin_dw" method="post">
				<table border="2" cellspacing="0" cellpadding="0" width="25%" align="center">
				<tr><td align="center">保存路径：</td>
				<td>
                           <SELECT name="Lujing">
					<option value="">请选择</option>
					<option value="D:\\工作量统计表.xls">D:\\</option>
					<option value="E:\\工作量统计表.xls">E:\\</option>
					<option value="F:\\工作量统计表.xls">F:\\</option>
				</SELECT>
                        </td>
