...
public class lookbytime extends ActionSupport{
	private String Time;
	...
	public String execute() throws Exception{
		...
		if(Time.length()==0){
			...
			return "error";
				...
				String sql1="select * from 科研项目 where 鉴定验收时间 like '%"+Time+"%'";
				...
				String sql2="select * from 出版专著 where 出版时间 like '%"+Time+"%'";
				...
				String sql3="select * from 获奖 where 获奖时间 like '%"+Time+"%'";
				...
				String sql4="select * from 学术兼职 where 任职开始时间 like '%"+Time+"%'";
				...
				String sql5="select * from 专利 where 时间 like '%"+Time+"%'";
